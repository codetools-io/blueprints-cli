...
function routePrompt(message) {
  const promptTemplate =
    PromptTemplate.fromTemplate(`Given the user message below and the provided functions, determine which functions should be executed.
                                     
Only respond with a list of the function names to be executed. Sort the functions according to the execution order.

<functions>
  <function name="createFile" description="Creates a new file">
    <argument name="filePath" description="File path for the new file" />
    <argument name="fileContent" description="File contents of the file" />
  </function>
  <function name="getFile" description="Gets a file and the file contents">
    <argument name="filePath" description="File path for the file" />
  </function>
  <function name="updateFile" description="Updates the contents of a file">
    <argument name="filePath" description="File path of the file" />
    <argument name="file" description="File path of the file" />
  </function>
